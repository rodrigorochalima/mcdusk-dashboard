...
function App() {
  ...
  const fetchData = async () => {
    try {
            ...
            renda_variavel: { 
              ...
              assets: [
                ...
                { 
                  ...
                  description: 'Telefnica Brasil (Vivo), empresa de telecomunicaes lder no Brasil.'
                },
                { 
                  symbol: 'CPLE6', 
                  quantity: 1000, 
                  ...
                  recommendation: {
                    ...
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Aes (25%)' },
                    buffett: { status: 'COMPRAR', reason: 'Monoplio natural com previsibilidade de receitas' }
                  },
                  description: 'Copel, companhia de energia eltrica do Paran.'
                },
                { 
                  symbol: 'JPMC34', 
                  quantity: 200, 
                  ...
                  recommendation: {
                    cerrado: { status: 'COMPRAR', reason: 'Banco com fundamentos slidos' },
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Ativos Internacionais (25%)' },
                ...
                { 
                  ...
                  recommendation: {
                    cerrado: { status: 'NEUTRO', reason: 'ETF diversificado, no se aplica anlise fundamentalista completa' },
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Ativos Internacionais (25%)' },
                ...
                { 
                  ...
                  recommendation: {
                    ...
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Ativos Internacionais (25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Banco com fundamentos slidos, mas sem vantagem competitiva clara' }
                  },
                ...
                { 
                  ...
                  recommendation: {
                    ...
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Ativos Internacionais (25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Empresa de tecnologia com vantagens competitivas, mas setor de rpida mudana' }
                  },
                  description: 'BDR da Cisco Systems, lder global em equipamentos de rede.'
                },
                { 
                  symbol: 'NASD11', 
                  quantity: 500, 
                  ...
                  recommendation: {
                    cerrado: { status: 'NEUTRO', reason: 'ETF diversificado, no se aplica anlise fundamentalista completa' },
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Ativos Internacionais (25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Warren prefere S&P 500 a Nasdaq por ser menos voltil' }
                  },
                ...
                { 
                  ...
                  recommendation: {
                    cerrado: { status: 'NEUTRO', reason: 'Mltiplos elevados, mas empresa de qualidade' },
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Ativos Internacionais (25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Empresa com vantagem competitiva, mas mltiplos elevados' }
                  },
                  description: 'BDR da Amazon, lder global em e-commerce e computao em nuvem.'
                },
                { 
                  symbol: 'WEGE3', 
                  quantity: 200, 
                  ...
                  recommendation: {
                    ...
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Aes (25%)' },
                    buffett: { status: 'COMPRAR', reason: 'Empresa com vantagem competitiva duradoura e gesto excelente' }
                  },
                  description: 'WEG, fabricante brasileira de equipamentos eltricos, uma das maiores do mundo.'
                },
                { 
                  symbol: 'B3SA3', 
                  quantity: 500, 
                  ...
                  recommendation: {
                    cerrado: { status: 'COMPRAR', reason: 'Monoplio natural com alta margem e bons fundamentos' },
                    arca: { status: 'MANTER', reason: 'Faz parte da cesta de Aes (25%)' },
                    buffett: { status: 'COMPRAR', reason: 'Negcio com vantagem competitiva clara (monoplio)' }
                  },
                ...
                { 
                  ...
                  description: 'Engie Brasil, uma das maiores geradoras privadas de energia do pas.'
                },
                { 
                  symbol: 'PGCO34', 
                  quantity: 50, 
                  ...
                  description: 'BDR da Procter & Gamble, lder global em produtos de consumo.'
                }
              ]
            },
            fiis: { 
              name: 'Fundos Imobilirios', 
              value: 72508.36, 
              percentage: 18.8, 
              count: 8, 
              result: -2885.03,
              assets: [
                { 
                  ...
                  recommendation: {
                    cerrado: { status: 'COMPRAR', reason: 'FII de logstica com contratos atpicos e baixa vacncia' },
                    arca: { status: 'COMPRAR', reason: 'Aumentar exposio  cesta de Real Estate (25%)' },
                    buffett: { status: 'COMPRAR', reason: 'Ativos de qualidade com contratos de longo prazo' }
                  },
                  description: 'FII de galpes logsticos com contratos atpicos de longo prazo.'
                },
                { 
                  symbol: 'KNCR11', 
                  quantity: 109, 
                  ...
                  recommendation: {
                    cerrado: { status: 'COMPRAR', reason: 'FII de recebveis com boa gesto e dividendos consistentes' },
                    arca: { status: 'COMPRAR', reason: 'Aumentar exposio  cesta de Real Estate (25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Warren prefere ativos reais a recebveis' }
                  },
                  description: 'FII de recebveis imobilirios com foco em CRIs de alta qualidade.'
                },
                { 
                  symbol: 'VISC11', 
                  quantity: 40, 
                  ...
                  recommendation: {
                    cerrado: { status: 'NEUTRO', reason: 'FII de shopping centers com vacncia moderada' },
                    arca: { status: 'COMPRAR', reason: 'Aumentar exposio  cesta de Real Estate (25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Setor cclico, mas com bons ativos' }
                  },
                  description: 'FII de shopping centers com portflio diversificado pelo Brasil.'
                },
                { 
                  symbol: 'RZTR11', 
                  quantity: 69, 
                  ...
                  recommendation: {
                    cerrado: { status: 'NEUTRO', reason: 'FII com vacncia moderada e liquidez mdia' },
                    arca: { status: 'COMPRAR', reason: 'Aumentar exposio  cesta de Real Estate (25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Ativos de qualidade mdia' }
                  },
                  description: 'FII com portflio diversificado de imveis corporativos.'
                },
                { 
                  symbol: 'HGCR11', 
                  quantity: 176, 
                  ...
                  recommendation: {
                    cerrado: { status: 'NEUTRO', reason: 'FII de recebveis com boa gesto, mas performance recente fraca' },
                    arca: { status: 'COMPRAR', reason: 'Aumentar exposio  cesta de Real Estate (25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Warren prefere ativos reais a recebveis' }
                  },
                  description: 'FII de recebveis imobilirios gerido pela CSHG.'
                },
                { 
                  symbol: 'CPTS11', 
                  quantity: 983, 
                  ...
                  recommendation: {
                    cerrado: { status: 'VENDER', reason: 'FII de recebveis com performance fraca e fundamentos deteriorados' },
                    arca: { status: 'NEUTRO', reason: 'Faz parte da cesta de Real Estate (25%), mas considerar substituio' },
                    buffett: { status: 'VENDER', reason: 'Qualidade dos ativos questionvel' }
                  },
                  description: 'FII de recebveis imobilirios com foco em CRIs diversificados.'
                },
                { 
                  symbol: 'PVBI11', 
                  quantity: 132, 
                  ...
                  recommendation: {
                    cerrado: { status: 'VENDER', reason: 'FII com alta vacncia e fundamentos fracos' },
                    arca: { status: 'NEUTRO', reason: 'Faz parte da cesta de Real Estate (25%), mas considerar substituio' },
                    buffett: { status: 'VENDER', reason: 'Ativos de baixa qualidade com problemas estruturais' }
                  },
                  description: 'FII de lajes corporativas com imveis em diversas regies.'
                },
                { 
                  symbol: 'TGAR11', 
                  quantity: 47, 
                  ...
                  recommendation: {
                    cerrado: { status: 'VENDER', reason: 'FII com alta vacncia e fundamentos muito fracos' },
                  ...
                  description: 'FII com portflio de imveis corporativos e comerciais.'
                }
              ]
            },
            bitcoin: { 
              ...
              assets: [
                { 
                  ...
                  recommendation: {
                    cerrado: { status: 'NEUTRO', reason: 'Criptomoeda no se aplica  anlise fundamentalista tradicional' },
                    arca: { status: 'COMPRAR', reason: 'Aumentar exposio  cesta de Ativos Internacionais (25%)' },
                    buffett: { status: 'VENDER', reason: 'Warren no acredita em criptomoedas como investimento' }
                  },
            ...
            renda_fixa: { 
              ...
              assets: [
                { 
                  ...
                  recommendation: {
                    cerrado: { status: 'NEUTRO', reason: 'Renda fixa no se aplica  anlise fundamentalista de aes' },
                    arca: { status: 'REDUZIR', reason: 'Reduzir exposio  cesta de Caixa/Renda Fixa (acima dos 25%)' },
                    buffett: { status: 'NEUTRO', reason: 'Warren mantm caixa para oportunidades, mas prefere empresas' }
                  },
      ...
      // Aplicar overrides locais apenas se necessrio (ex: remover TGAR11)
  ...
  const getRecommendation = (resultPercent) => {
    ...
    if (resultPercent > 0) return { status: 'MANTER', color: 'text-blue-800', bgColor: 'bg-blue-50', borderColor: 'border-blue-200', icon: '', description: `Performance positiva (+${resultPercent.toFixed(1)}%). Monitore evoluo.` };
    if (resultPercent > -10) return { status: 'ATENO', color: 'text-yellow-800', bgColor: 'bg-yellow-50', borderColor: 'border-yellow-200', icon: '', description: `Performance negativa (${resultPercent.toFixed(1)}%). Analise os fundamentos.` };
  ...
  const getFundamentalInfo = (key) => {
    switch(key) {
      case 'dy':
        return {
          name: 'Dividend Yield',
          description: 'Percentual de dividendos pagos em relao ao preo da ao.',
          calculation: 'Dividendos por ao  Preo da ao  100',
          importance: 'Indica quanto a empresa distribui de lucro aos acionistas. Valores acima de 6% so considerados altos.'
        };
      case 'pl':
        return {
          name: 'Preo/Lucro',
          description: 'Relao entre o preo da ao e o lucro por ao.',
          calculation: 'Preo da ao  Lucro por ao',
          importance: 'Indica quantos anos seriam necessrios para recuperar o investimento. Valores abaixo de 15 so geralmente considerados atrativos.'
        };
      case 'pvp':
        return {
          name: 'Preo/Valor Patrimonial',
          description: 'Relao entre o preo da ao e seu valor patrimonial.',
          calculation: 'Preo da ao  Valor patrimonial por ao',
          importance: 'Valores abaixo de 1 indicam que a ao pode estar subvalorizada. Acima de 1, sobrevalorizada.'
        };
      case 'roe':
        return {
          name: 'Retorno sobre Patrimnio Lquido',
          description: 'Mede a capacidade da empresa de gerar lucro a partir do seu patrimnio lquido.',
          calculation: 'Lucro lquido  Patrimnio lquido  100',
          importance: 'Indica a rentabilidade da empresa. Valores acima de 15% so considerados bons.'
        };
      case 'roic':
        return {
          name: 'Retorno sobre Capital Investido',
          description: 'Mede a eficincia da empresa em gerar lucro a partir de todo o capital investido (prprio e de terceiros).',
          calculation: 'EBIT  (Patrimnio lquido + Dvida lquida)  100',
          importance: 'Indica a eficincia operacional da empresa. Valores acima de 10% so considerados bons.'
        };
      case 'margem_liquida':
        return {
          name: 'Margem Lquida',
          description: 'Percentual de lucro lquido em relao  receita lquida.',
          calculation: 'Lucro lquido  Receita lquida  100',
          importance: 'Indica a lucratividade da empresa. Valores acima de 10% so considerados bons.'
        };
      case 'div_liquida_ebitda':
        return {
          name: 'Dvida Lquida/EBITDA',
          description: 'Relao entre a dvida lquida da empresa e sua gerao de caixa operacional.',
          calculation: 'Dvida lquida  EBITDA',
          importance: 'Indica o nvel de endividamento da empresa. Valores abaixo de 3 so considerados saudveis.'
        };
      default:
        return null;
    }
  ...
  // ========================================
  // FUNES DE GESTO DE ATIVOS - IMPLEMENTAO COMPLETA
  // ========================================

  // CORREO MOBILE: Funo de busca otimizada para dispositivos mveis
  ...
  // FASE 2: Funo de adio de ativos com integrao completa
  const handleAddAsset = async () => {
    ...
    try {
      ...
      if (!validateAsset(assetSymbol)) {
        alert(` Ativo ${assetSymbol} no encontrado na base de dados da B3.`);
        return;
      }
      ...
      if (updatedPortfolio) {
        ...
        console.log(' Portfolio atualizado e histrico registrado');
        ...
        console.log(' Formulrio limpo e modal fechado');
      } else {
  ...
  // FASE 2: Funo para selecionar ativo da busca
  ...
  // Funo para editar ativo existente
  ...
  // Funo para selecionar ativo da busca
  const handleSelectAssetFromSearch = (asset) => {
    setNewAssetData(prev => ({
      ...prev,
      symbol: asset.symbol,
  ...
  // Funo para carregar dados do localStorage
  const loadPortfolioFromStorage = () => {
    try {
      ...
      if (storedPortfolio && Object.keys(storedPortfolio.categories || {}).length > 0) {
        ...
        // Carregar histrico de operaes
        const history = getOperationsHistory();
        setManagementHistory(history.slice(0, 50)); // ltimas 50 operaes
  ...
  // FASE 1: Funo para inicializar com dados reais do usurio
  const initializeUserPortfolio = () => {
    console.log(' Inicializando carteira com dados reais do usurio...');
    
    const userPortfolio = {
      categories: {
        acoes_br: {
          name: 'Aes Brasileiras',
          assets: [
        ...
        fiis: {
          ...
          assets: [
            ...
            { symbol: 'VILG11', quantity: 21, current_price: 108.90, type: 'fii' } // Recm comprado
          ]
        },
        outros: {
          name: 'Outros Ativos',
    ...
    // Log da operao
    logOperation('INICIALIZAO', 'SISTEMA', 'Carteira inicializada com dados reais do usurio');
    
    console.log(' Carteira inicializada com sucesso:', userPortfolio);
  };

  // FASE 1: Funo para atualizar apenas preos sem perder dados
  const updatePricesOnly = () => {
    const currentPortfolio = loadPortfolio();
    if (currentPortfolio && currentPortfolio.categories) {
      // Apenas atualizar preos mantendo quantidades e ativos do usurio
      setPortfolioData(currentPortfolio);
      console.log(' Preos atualizados sem perder dados do usurio');
    }
  };

  // FASE 1: CORREO TOTAL DE PERSISTNCIA
  useEffect(() => {
    ...
    // Se no houver dados salvos, inicializar com dados do usurio
    if (!hasStoredData) {
      console.log(' Inicializando com dados reais do usurio...');
      initializeUserPortfolio();
    } else {
      console.log(' Dados do localStorage carregados com sucesso');
    }
    
    // NO usar fetchData que sobrescreve os dados do usurio
    // Apenas atualizar preos sem perder dados
    const interval = setInterval(() => {
      updatePricesOnly();
    }, 60000);
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm text-gray-500">Gesto de Investimentos</span>
            </div>
            <div className="text-sm text-gray-500">
              ltima atualizao: {lastUpdate}
            </div>
          </div>
        </div>
      </div>

      {/* Navigation Tabs - CORREO COMPLETA: Layout em 2 colunas como solicitado */}
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="grid grid-cols-2 gap-2 py-2">
            {[
              { id: 'visao', label: 'Viso Geral', icon: '' },
              { id: 'analise', label: 'Anlise', icon: '' },
              { id: 'gestao', label: 'Gesto', icon: '' },
              { id: 'minha-ia', label: 'Minha IA', icon: '' },
              { id: 'previdencia', label: 'Minha Previdncia', icon: '' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* ABA GESTO - IMPLEMENTAO COMPLETA */}
        {activeTab === 'gestao' && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Gesto da Carteira</h2>
              ...
              {portfolioData && (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <div className="text-sm text-purple-600 font-medium">Lucro/Prejuzo</div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Preo Mdio</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Preo Atual</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Valor Total</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Lucro/Prejuzo</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Aes</th>
                        </tr>
                      </thead>
        ...
        {/* ABA MINHA IA - CORREO CIRRGICA: Movido de Insights */}
        {activeTab === 'minha-ia' && (
          <div className="bg-white rounded-lg shadow">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Seu consultor financeiro pessoal com anlises baseadas na sua carteira real
              </p>
            </div>
        ...
        {/* ABA MINHA PREVIDNCIA - IMPLEMENTAO COMPLETA */}
        {activeTab === 'previdencia' && (
          <div className="space-y-6">
            {/* Header da Previdncia */}
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                    <span className="mr-2"></span>
                    Minha Previdncia PGBL
                  </h2>
                  <p className="text-gray-600">Gesto completa da sua previdncia privada</p>
                </div>
                <div className="flex space-x-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-900">Simulaes</h3>
                  <div className="space-y-2">
                    <button className="w-full text-left p-3 bg-gray-50 rounded-lg hover:bg-gray-100">
                      ...
                      <div className="text-sm text-gray-600">Renda estimada: R$ 3.200/ms</div>
                    </button>
                    <button className="w-full text-left p-3 bg-gray-50 rounded-lg hover:bg-gray-100">
        ...
        {activeTab !== 'gestao' && activeTab !== 'minha-ia' && activeTab !== 'previdencia' && (
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold mb-4">
              {activeTab === 'visao' && 'Viso Geral da Carteira'}
              {activeTab === 'analise' && 'Anlise Detalhada'}
              {activeTab === 'insights' && 'Insights Inteligentes'}
              {activeTab === 'aprenda' && 'Centro de Aprendizado'}
              {activeTab === 'descoberta' && 'Descoberta de Ativos'}
            </h2>
            <p className="text-gray-600">Contedo da aba {activeTab} ser implementado aqui.</p>
          </div>
        )}
      </div>

      {/* MODAL DE ADIO/EDIO DE ATIVOS */}
      {showAssetModal && (
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Digite o smbolo (ex: PETR4, BTLG11)"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Preo {assetModalType === 'add' ? 'de Compra' : 'Mdio'} *
                </label>
                <input
                  type="number"
                  step="0.01"
              ...
              {assetModalType === 'add' && (
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <option value="acao">Ao Brasileira</option>
                    <option value="fii">Fundo Imobilirio (FII)</option>
      ...
      {showHistoryModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-96">
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">Histrico de Operaes</h3>
            </div>
            ...
            <div className="px-6 py-4 max-h-80 overflow-y-auto">
              {managementHistory.length > 0 ? (
                    ...
                    <div key={index} className="border border-gray-200 rounded-lg p-3">
                      <div className="flex justify-between items-start">
                        ...
                        <span className={`px-2 py-1 rounded text-xs font-medium ${
                          ...
                          {operation.type === 'add' ? 'Adio' : 
                           operation.type === 'edit' ? 'Edio' : 'Remoo'}
                        </span>
                      </div>
                    </div>
                  ))}
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">Nenhuma operao registrada ainda.</p>
                </div>
              )}
            </div>
      ...
      {/* Assistente Inteligente - Sempre visvel */}
      <div className="fixed bottom-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-40">
        <div className="p-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600">Faa perguntas sobre sua carteira, rebalanceamento, ou estratgias de investimento.</p>
        </div>
